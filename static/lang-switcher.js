document.addEventListener('DOMContentLoaded', () => {
    ...
    function applyTranslations(translations) {
        ...
        elements.forEach(element => {
            ...
            if (!translation && key === 'howItWorks.content') {
                translation = getNestedTranslation(translations, 'how-it-works.content');
            } else if (!translation && key === 'how-it-works.content') {
                translation = getNestedTranslation(translations, 'howItWorks.content');
            }
            ...
            if (translation) {
                ...
                } else if (key === 'about.content' || key === 'howItWorks.content' || key === 'how-it-works.content') { // Allow HTML in about and how it works content
